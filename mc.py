...
from PyQt5.QtCore import Qt                             # Модуль із константами, наприклад для 
...
questions_list = [] 
questions_list.append( Question("банан?", "банан.", "банан(", "банан!", "банан)") ) 
questions_list.append( Question("2 + 2 * 2?", "6", "4", "8", "12") 
) 
questions_list.append( Question("ы?", "Ы", "ьІ", "bI", "ь|") ) 
...
next_question() 
# Якщо текст на кнопці"Answer" 
# Перевіряємо відповідь 
# Інакше — показуємо наступне питання 
